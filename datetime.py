...
class DateColumn:
  ...
  def get_weekend(self):
    ...
    """
    num_weekend = (df[col_name].dt.day_name().isin(['Saturday', 'Sunday'])).sum()
    return num_weekend
  ...
  def get_weekday(self):
    ...
    """
    num_weekday = (~df[col_name].dt.day_name().isin(['Saturday', 'Sunday'])).sum()
    return num_weekday
  ...
  def get_future(self):
    ...
    num_futureday = (df[col_name] > today).sum()
  ...
  def get_empty_1900(self):
    ...
    num_1990 = (df[col_name] == year_1900).sum()
    return num_1990
  ...
  def get_empty_1970(self):
    ...
    num_1970 = (df[col_name] == year_1970).sum()
    return num_1970
  ...
  def get_barchart(self):
    ...
    """
    bar_chart = st.bar_chart(df[col_name].value_counts())
    return bar_chart
  ...
  def get_frequent(self):
    ...
    """
    percent = (df[col_name].value_counts()/df[col_name].count())*100  
    occurence = df[col_name].value_counts()
